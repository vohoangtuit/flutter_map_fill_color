...
class _EarthGlobeScreenState extends State<EarthGlobeScreen> {
  ...
  final List<String> _textures = [
    'assets/images/2k_earth-day.jpg',
    'assets/images/2k_earth-night.jpg',
    'assets/images/2k_jupiter.jpg',
    'assets/images/2k_mars.jpg',
    'assets/images/2k_mercury.jpg',
    'assets/images/2k_moon.jpg',
    'assets/images/2k_neptune.jpg',
    'assets/images/2k_saturn.jpg',
    'assets/images/2k_stars.jpg',
    'assets/images/2k_sun.jpg',
    'assets/images/2k_uranus.jpg',
    'assets/images/2k_venus_surface.jpg'
  ];
  ...
  initState() {
    ...
    points = [
      Point(
          id: '1',
          coordinates: const GlobeCoordinates(10.82302, 106.62965),
          label: 'Ho Chi Minh',
          // labelBuilder: pointLabelBuilder,
          onTap: (){
            print('Ho Chi Minh');
          },
          style:  PointStyle(color: Colors.pink.shade900, size: 6)),
      Point(
          id: '2',
      ...
      PointConnection(
          ...
          onTap: () {
            showDialog(
                context: context,
                builder: (context) => const AlertDialog(
                  title: Text('Ho Chi Minh to London'),
                  content: Text(
                      'This is a connection between Ho Chi Minh and London'),
                ));
          },
